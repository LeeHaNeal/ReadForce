...
public class EmailService {
    ...
    public void sendPasswordChangeNotification(String email) {
        String subject = "[ReadForce] 비밀번호 변경 안내";
        String text =
                DEFAULT_MESSAGE + "\n" +
                        "비밀번호 변경이 완료되었습니다.\n";
    ...
    public void markEmailAsVerified(String email) {
    	System.out.println("qwerqwersdfasdfasdfasdf   " +  email);
    ...
    public void saveSocialSignUpInfo(String temporalToken, OAuthAttributeDto oAuthAttributeDto, String socialProvider, String socialId) {
        try {
            ...
            String socialInfoJson = objectMapper.writeValueAsString(socialInfo);
