...
//		
//		Classification classificationEntity = classificationService.getClassificationByClassfication("TEST");
//				
...
//				 
//				String author = Name.GEMINI.name();
//				 
//				LocalDate publicationDate = LocalDate.now();
//				 
//				Category categoryEntity = categoryService.getCategoryByCategory("VOCABULARY");
//
//				passageService.savePassage(parsedResult.getTitle(), parsedResult.getContent(), author, publicationDate, categoryEntity, level, language, classificationEntity);
//				
//			}
//			
//		}
...
//		for(Language language : languageList) {
//			
//			List<PassageResponseDto> unusedPassageList = questionService.getUnusedVocabularyPassageList(language.getLanguage(), "TEST");
//			
...
//			
//			String prompt = gernerateTestQuestionPrompt(language, level, title, content);
//			
//			
//			
//		}
...
//	}
//	
//	private String gernerateTestQuestionPrompt(Language language, Level level, String title, String content) {
//		
//		String prompt = "";
//		
//		switch(language.getLanguage()) {
...
//						}
//				""", level.getLevel(), level.getVocabularyLevel(), title, title, content);
//		
//		}
//		
//		return prompt;
